...
pub struct MerchantOrderReviveShipmentResponse {
    /// Success message
...
impl MerchantOrderReviveShipmentResponse {
    pub fn new(message: String, order_uuid: uuid::Uuid, status: models::OrderStatusEnum, status_display: String) -> MerchantOrderReviveShipmentResponse {
