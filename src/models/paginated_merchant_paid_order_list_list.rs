...
pub struct PaginatedMerchantPaidOrderListList {
    ...
    pub results: Vec<models::MerchantPaidOrderList>,
}

impl PaginatedMerchantPaidOrderListList {
    pub fn new(results: Vec<models::MerchantPaidOrderList>) -> PaginatedMerchantPaidOrderListList {
