...
**main_amount** | **i32** | مجموع قیمت‌های اولیه تمام کالاها بدون تخفیف (به تومان) | [readonly]
...
**discount_amount** | **i32** | کل تخفیف اعمال شده بر سفارش (به تومان) | [readonly]
...
**preparation_time** | **i32** | زمان آمادهسازی سفارش (به روز) | [readonly]
**weight** | **f64** | وزن کل سفارش (بر حسب گرم) | [readonly]
...
**digipay_markup_amount** | **i32** | مبلغ نشانه‌گذاری برای سفارش (به تومان) | [readonly]
**markup_commission_percentage** | **i32** | درصد کمیسیون نشانه‌گذاری برای سفارش (به درصد) | [readonly]
